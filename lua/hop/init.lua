...
local function grey_things_out(buf_handle, hl_ns, top_line, bottom_line)
  ...
  -- Set Priority really high to override other highlight groups, bottom_line+1 to avoid getting line length.
  vim.api.nvim_buf_set_extmark(buf_handle, hl_ns, top_line, 0,
    {end_line=bottom_line+1, hl_group="NonText", priority=10000})
end
